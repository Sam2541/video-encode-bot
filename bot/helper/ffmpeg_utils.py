...
def encode(filepath):
    ...
    if video_codec[0] == 'hevc':
        ...
        #video_opts = '-c:v libx265 -crf 25 -tag:v hvc1 -preset slow -threads 8'
        video_opts = '-c:v libx265 -map 0 -crf 25 -profile:v main10 -threads 8 -preset slow -pix_fmt yuv420p10le'
